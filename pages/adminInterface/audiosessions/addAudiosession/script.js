window.onload = function () {
    ...
    dataAudiosession1__col2_smalldescription.id = "smalldescription";
    ...
    // 1.3-1
    const dataAudiosession2__addaudio = document.createElement('input');
    ...
    dataAudiosession2__fulldescription.id = "fulldescription";
    ...
    form.onsubmit = (e) => {
        ...
        axios.post("http://ServerCerebry/audioSession/createAudiosession", fd).then(res => {
            console.log(res);
        });
    }
    ...
    let addAudiosession = document.querySelector('#addAudiosession');
